...
def run_test_practice_problem2a():
    ...
    seq = [1, 2, 3, 4, 6]
    delta = 3
    print("Expected: [4, 5, 6, 7, 9]")
    print("Actual:", practice_problem2a(seq, delta))

    print()
    seq = [98234]
    delta = 29
    print("Expected: [98263]")
    print("Actual:", practice_problem2a(seq, delta))

    print()
    seq = [7, 9, 23]
    delta = 0
    print("Expected: [7, 9, 23]")
    print("Actual:", practice_problem2a(seq, delta))

    print()
    seq = [11, 23, 35]
    delta = 10
    print("Expected: [21, 43, 45]")
    print("Actual:", practice_problem2a(seq, delta))
